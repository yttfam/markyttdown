...
| Side-by-side |
| :---: |
| ![Side-by-side](docs/screenshots/split.png) |

| Editor | Preview |
| :---: | :---: |
| ![Editor](docs/screenshots/editor.png) | ![Preview](docs/screenshots/preview.png) |

*Snapshots regenerated by `markyttdownTests/ScreenshotGenerator.swift` from the
same renderer pipeline the app uses.*
